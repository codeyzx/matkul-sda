...
int main()
{
    ...
    *(int *)MyTabInt = 1;
    ...
    geser((int *)MyTabInt, (void (*)(void *))succI);
    geser((int *)MyTabC, (void (*)(void *))succC);
    printf(" dalam main \n");
    printf(" Tabel integer \n");
    printtab((int *)MyTabInt, 0);
    printf(" Tabel charakter \n");
    ...
    geser((int *)MyTabInt, (void (*)(void *))predI);
    geser((int *)MyTabC, (void (*)(void *))predC);
    printf(" dalam main \n");
    printf(" Tabel integer \n");
    printtab((int *)MyTabInt, 0);
    printf(" Tabel charakter \n");
